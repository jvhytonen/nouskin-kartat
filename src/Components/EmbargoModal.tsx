...
/**
 * A modal showing information about the embargo related to the competitions arranged 2025.
 * 
 */
...
const EmbargoModal = ({ close }: EmbargoModalType) => {
    return (
        <div className='absolute top-5 left-5 w-4/5 md:w-3/5 lg:w-2/5 xl:w-2/5 rounded-lg border-black border-2'>
