...
{ lng: 23.0458832, lat: 61.7635427 },
{ lng: 23.0790997, lat: 61.7627714 },
{ lng: 23.0853224, lat: 61.7712956 },
{ lng: 23.0661392, lat: 61.7750902 },
{ lng: 23.0495310, lat: 61.7785597 },
{ lng: 23.0444241, lat: 61.7799595 },
{ lng: 23.0391884, lat: 61.7800606 },
{ lng: 23.0367851, lat: 61.7751507 },
{ lng: 23.0458403, lat: 61.7636062 },
 */
  ...
  return isLoaded ? (
    ...
    >
      <div>
        {testObj.map((item) => {
          return (
            <Polygon key={item.id} paths={item.coordinates} />
          )
        })}
      </div>
      <></>
