...
const FullMap = ({ fullMapUrl, closeMap, name }: FullMapType) => {
    ...
    const landscapeDivStyle = 'fixed top-1/4 left-1 w-[calc(100vw_-_10px)] md:w-[calc(100vw_-_15%)] lg:w-[calc(100vw_-_30%)] xl:w-[calc(100vw_-_40%)] h-auto sm:top-[10%] md:top-[3%] flex items-center justify-center border-slate-200 border-4 rounded-lg pb-6 md:p-10'
    const portraitDivStyle = 'fixed top-[10%] left-[50%] w-[calc(100vw_-_10px)] translate-x-[-50%] mx-auto max-h-[calc(100vh_-_30%)] py-[8%] sm:py-[5%] xsm:px-[1%] px-[2%] xsm:w-[calc(100vw_-_20%)] sm:w-[calc(100vw_-_55%)] md:sm:w-[calc(100vw_-_65%)] lg:w-[calc(100vw_-_70%)] xl:w-[calc(100vw_-_75%)]'
